...
<main class=" vh-100 sm d-flex justify-content-center align-items-center">
    <section class=" sm rounded-3 pt-4 pb-4 ps-4 pe-4 w-35 bg-white text-dark d-flex flex-column align-items-center">
            <form name="signup" class="p-3" onsubmit="validate(event)" method="POST" action="./students/add.php">
                ...
                <div class="d-flex flex-column flex-sm-row gap-3">
                    <div class="mb-3 w-100">
                        ...
                        <input class="form-control p-1" type="text" id="fname" name="Fname"/>
                        <small class="alert alert-danger fs-9 border-0" id="fnameError"></small>
                    </div>
                    <div class="mb-3 w-100">
                        <label for="lname" class="form-label  text-muted">Last Name</label>
                        <input class="form-control p-1" id="lname" type="text" name="Lname" />
                        <small class="alert alert-danger fs-9 border-0" id="lnameError"></small>
                    </div>
                </div>
                 <div class="mb-3">
                    <label for="username" class="form-label  text-muted">Username</label>
                    <input class="form-control p-1" type="text" id="username" name="username" />
                     <small class="alert alert-danger fs-9 border-0" id="usernameError"></small>
                </div>
                <div class="mb-3">
                    <label for="email"  class="form-label  text-muted">Email</label>
                    <input class="form-control p-1" type="email" id="email" name="email" />
                    <small class="alert alert-danger fs-9 border-0" id="emailError"></small>
                </div>
                <div class="mb-3">
                    <label for="password" class="form-label  text-muted">Password</label>
                    <input class="form-control p-1" id="password" type="password" name="password" />
                    <small class="alert alert-danger fs-9 border-0" id="passError"></small>
                </div>
                <div class="text-center mb-3">
